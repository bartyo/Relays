...
const char* url_relay = "https://projsante.herokuapp.com/api/relays/devices";
...
struct_sensor g_sensor[NB_SENSORS];//This lise cause issue, no more memory?
/***DE PROCESS.INO***/
...
void loop() {
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) 
  {
    ...
    if(millis() - timer_relay > 100000)//request relays
    {
      timer_relay = millis();
